...
Görbék: vannak értelmezve
#### Görbék megadása explicit függvény használatával
Ez az egyetlen görbe megadási mód az említettek közül, amely tényleges függvény, mivel minden x értékhez csak egy y értéket rendel.
Az explicit függvényeket a következő alakban tudjuk megadni
$$
y = f(x)
$$
...
#### Görbék implicit megadás:
Ezek már technikailag nem függvények, mivel nem egyértelmű hozzárendelés, mivel itt egy x-nél több y is lehet -> maguk alá tudnak fordulni a görbék
Általános alakjuk:
$$
F(x, y) = 0
$$
#### Görbék paraméteres megadása
