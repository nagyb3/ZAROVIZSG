...
->**Élkonzisztencia**: minden élt konzisztenssé teszünk: X -> Y él konzisztens, ha elmondhatjuk azt, hogy X minden értékéhez, Y tud rendelni saját magának egy értéket úgy, hogy a kényszer teljesüljön
...
NEM TELJES, mivel képes beragadni, ha kicsi heurisztikája csúcsokat talál
NEM OPTIMÁLIS
### A* keresés
