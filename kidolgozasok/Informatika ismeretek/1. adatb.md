...
chatgpt said:
A "koncepcionális adatbázis-tervezés" azt jelenti, hogy még a konkrét adatbázis-technológia (pl. SQL, MongoDB) kiválasztása _előtt_ megtervezed az adatokat és azok kapcsolatait egy magasabb, elvont szinten.

Egyszerűbben:  
Ez az a fázis, amikor azt gondolod végig, hogy **milyen adatok** kellenek, **hogyan kapcsolódnak** egymáshoz, **milyen szabályok** vonatkoznak rájuk — de még nem érdekel, hogy pontosan milyen táblák vagy lekérdezések lesznek.
